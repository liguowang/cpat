...
test <- read.table(file="test_noncoding_fasta.dat",sep="\t",col.names=c("ID","mRNA","ORF","Fickett","Hexamer"))
...
write.table(output,file="test_noncoding_fasta",quote=F,sep="\t",row.names=ID)
